...
<body>  
    ...
    <div class="main">
        ...
        <form action="" method="post">
            <fieldset>
                <legend>Borrar resultados</legend>
                <?php
                    include('init.php');
                    include('session.php');
                    ...
                    echo'</select>'
                ?>
                <input type="text" name="rno" placeholder="Núm. de matricula">
        ...
        <form action="" method="post">
            <fieldset>
                <legend>Actualizar resultados</legend>
                <?php
                    $class_result=mysqli_query($conn,"SELECT `name` FROM `project_03_class`");
                    ...
                    echo'</select>'
                ?>     
                <input type="text" name="rn" placeholder="Núm. de matricula">
                <input type="text" name="p1" id="" placeholder="Primer parcial">
                <input type="text" name="p2" id="" placeholder="Segundo parcial">
                <input type="text" name="p3" id="" placeholder="Tercer parcial">
                <input type="text" name="p4" id="" placeholder="Cuarto parcial">
...
<?php
    if(isset($_POST['class_name'],$_POST['rno'])) {
        ...
        echo $class_name;
        echo $rno;
        $delete_sql=mysqli_query($conn,"DELETE from `project_03_result` where `rno`='$rno' and `class`='$class_name'");
        if(!$delete_sql){
            ...
            echo '<script language="javascript">';
            echo 'alert("Calificaciones eliminadas")';
            echo '</script>';
        }
    }
    if(isset($_POST['rn'],$_POST['p1'],$_POST['p2'],$_POST['p3'],$_POST['p4'],$_POST['p5'],$_POST['class'])) {
        ...
        $percentage=$marks/5;
        $sql="UPDATE `project_03_result` SET `p1`='$p1',`p2`='$p2',`p3`='$p3',`p4`='$p4',`p5`='$p5',`marks`='$marks',`percentage`='$percentage' WHERE `rno`='$rno' and `class`='$class_name'";
        ...
        if(!$update_sql){
            ...
            echo '<script language="javascript">';
            echo 'alert("Calificaciones actualizadas")';
            echo '</script>';
        }
    }
?>